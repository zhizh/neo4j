...
class BeginMessageDecoderV52Test extends DefaultBeginMessageDecoderTest {

    @Override
    public BeginMessageDecoderV52 getDecoder() {
        return BeginMessageDecoderV52.getInstance();
    }
